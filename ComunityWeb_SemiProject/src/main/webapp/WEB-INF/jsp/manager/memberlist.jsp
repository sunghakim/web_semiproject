  ...
  <section class="main">
    ...
    <div id="catecol" class="d-flex align-items-start col-lg-3 col-md-3" >
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="location.href=''">회원관리</button>
   ...
   <!-- main_contents -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-uppercase mb-0">회원 리스트</h5>
                </div>
                <div class="table-responsive">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td><button type="button" id="memberlist-clearall" class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" onclick="deleteallMember()"><i class="fas fa-trash-alt"></i> </button></td>
                    </tr>
                  </tfoot>
                </table>
            </div>

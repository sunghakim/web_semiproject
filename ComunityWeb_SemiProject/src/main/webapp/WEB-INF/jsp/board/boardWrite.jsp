...
<link href="/css/boardWrite.css" type="text/css" rel="stylesheet">
...
<div id="content">
        ...
        <form class="frmWrite">
            <div class="writeHd">
                <select class="frm" id="writeSelect" style="margin-right: 5px;" required>
                    <option value="">카테고리 선택</option>
                    <option value="1">카테고리1</option>
                    <option value="2">카테고리2</option>
                    <option value="3">카테고리3</option>
                </select>
                <input class="frm" id="writeTitle" placeholder="제목" style="margin-left: 4px;" required>
            </div>
            <hr>
            <div class="writeHd">
              <textarea class="frm" id="writeContent" placeholder="내용" style="overflow: auto;" required></textarea>
            </div>
